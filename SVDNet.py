...
def dense_block_1(x, num_filters):
    ...
    conv = Conv_2D_Block(pool, num_filters, (3, 3), (1,1))
    conv = Conv_2D_Block(conv, num_filters, (3, 3), (1,1))
    x = tf.keras.layers.concatenate([pool, conv], axis=-1)
    return x
...
class SVDNet:
    ...
    def SVDNet(self):
        ...
        Dense_Block_2 = dense_block_2(Transition_Block_1, self.num_filters * 4)
        Transition_Block_2 = transition_block(Dense_Block_2, self.num_filters)

        Dense_Block_3 = dense_block_3(Transition_Block_2, self.num_filters * 8)
        Transition_Block_3 = transition_block(Dense_Block_3, self.num_filters)

        Dense_Block_4 = dense_block_4(Transition_Block_3, self.num_filters * 8)
